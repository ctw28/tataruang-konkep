...
<html lang="en">
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="horizontal-index.html"><i class="ti ti-minus"></i>Analytics</a></li>
    ...
    <script>
    var mymap = L.map('mapid').setView([-4.115246, 123.087998], 11);
...
// }).addTo(mymap);
    ...
    var jsonTest = new L.GeoJSON.AJAX(["{{route('shptogeojson')}}"],{onEachFeature:popUp, style:myStyle}).addTo(mymap);
